        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedSemester == null){
                    ...
                    // String semester, String courseNumber, String courseName, double courseHours, String letterGrade
                    Grade grade = new Grade(selectedSemester.getName(), selectedCourse.getNumber(), selectedCourse.getName(),selectedCourse.getHours(),selectedLetterGrade.getLetterGrade());
